# Indian Driving Dataset for Event Reasoning (IDD-ER)
...
The raw video clips used in this project, i.e. the **Indian Driving Dataset for Event Reasoning (IDD-ER)** is sourced from the **IDD-X Dataset** ("IDD-X: A Multi-View Dataset for Ego-relative Important Object Localization and Explanation in Dense and Unstructured Traffic"). 
